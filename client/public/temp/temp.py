...
def run(input_json, context=None):
    messages = []
    messages.append({"role": "system", "content": "Let's make a joke about " + input_json["subject"] + "!"})
    if context:
        messages.append({"role": "user", "content": "This is the context: " + context + "\nLet's make a joke about the subject: " + input_json["subject"]})
    else:
        messages.append({"role": "user", "content": "Let's make a joke about the subject: " + input_json["subject"]})
